...
from django.views.generic import View,CreateView,FormView,TemplateView,DetailView,UpdateView,ListView
    ...
    def get_context_data(self, **kwargs):
        ...
        for pro in userprofiles:
            for u in pro.followings.all():
                lst.append(u)
        print("followers cnt of logined user",lst.count(self.request.user))
...
# localhost:8000/users/<int:pk>/follwing/add
